...
ppsbin_info () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript ppsbin search_by "[[{'pps_id', 'equal', $1},{'ppsbin_id', 'equal', \""$2"\"}], 'record']."
    echo '</pre>'
}
...
echo '<title>Specific Bin Info</title>'
echo '</head>'
