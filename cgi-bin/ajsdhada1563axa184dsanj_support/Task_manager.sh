...
echo '<div class="vertical-menu"></div><a href="/cgi-bin/Task/ppstask_started_id.sh"class="active" target="_blank"><b>All PPS Task on PPS for status started</b> </a>' 

echo '<div class="vertical-menu"></div><a href="/cgi-bin/Task/ppstask_rackpicked_id.sh" class="active" target="_blank"><b>All PPS Task on PPS for status rack_picked</b></a>' 

echo '<div class="vertical-menu"></div><a href="/cgi-bin/Task/audittaskstarted_id.sh" class="active" target="_blank"><b>All Audit Task on PPS for status started</b></a>' 

echo '<div class="vertical-menu"></div><a href="/cgi-bin/Task/audittask_rackpicked_id.sh" class="active" target="_blank"><b>All Audit Task on PPS for status rack_picked</b></a>' 
...
echo '<div class="vertical-menu"></div><a href="/cgi-bin/Task/pending_auditrec.sh" class="active" target="_blank"><b>Get all auditrec on PPS</b></a>' 
