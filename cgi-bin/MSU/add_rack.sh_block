...
rack_spotter () {
    ...
    echo '<pre>'
    sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript application set_env "['butler_server',\"default_racktype_id\" , \""$2"\"]."
    #rack_spotter:add_butlers([5607]).
    sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript rack_spotter add_butlers "[[$1]]."
    #rack_spotter:set_remaining_coordinates([{10,53}]).
    sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript rack_spotter set_remaining_coordinates "[[{$3, $4}]]."
    echo '</pre>'
}
