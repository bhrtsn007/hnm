...
task_associated_to_rack () {
    if [ "$2" -eq "0" ]; then
        ...
        echo "<br>"
        echo '<pre>'
        sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript ppstaskrec search_by "[[{'rack','equal',{'rackrec',<<\"$1\">>,0}},{'status', 'notequal', 'complete'}], 'record']."
        echo '</pre>'
        echo "Audit Task associated to this rack"
        echo "<br>"
        echo '<pre>'
        ...
        echo "<br>"
        echo '<pre>'
        sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript ppstaskrec search_by "[[{'rack','equal',{'rackrec',<<\"$1\">>,1}},{'status', 'notequal', 'complete'}], 'record']."
        echo '</pre>'
        echo "Audit Task associated to this rack"
        echo "<br>"
        echo '<pre>'
